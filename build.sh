...
export ZIP_DIR="/home/devabhi/ftp"
...
which avbtool &>/dev/null && python2 `which avbtool` add_hash_footer --partition_name dtbo --partition_size $((8 * 1024 * 1024)) --image "${ANYKERNEL}/dtbo.img"
cd - || exit
cd "${ANYKERNEL}" || exit
